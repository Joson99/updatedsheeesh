...
provinceDropdown.addEventListener('change', () => {
    ...
    if (provinceDropdown.value === 'Cavite') {
        // If "Cavite" is selected, enable the City/Municipality dropdown
        cityDropdown.disabled = false;
    } else {
        // If a different option is selected, disable the City/Municipality dropdown
        cityDropdown.disabled = true;
    }
});

// Initialize the disabled state of the City/Municipality dropdown based on the initial value of the Province dropdown
if (provinceDropdown.value === 'Cavite') {
    cityDropdown.disabled = false;
} else {
    cityDropdown.disabled = true;
